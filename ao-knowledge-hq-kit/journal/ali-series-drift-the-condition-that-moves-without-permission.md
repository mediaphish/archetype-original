...
summary: "Drift is not a failure. It is the direction failure travels in when no one is watching closely enough. It is measurable, predictable, and almost always well underway before the people responsible for fixing it know it exists."
categories:
  - servant-leadership
  - culture-science
featured_image: ../images/ali-series-drift-the-condition-that-moves-without-permission.jpg
takeaways:
  - "Drift does not begin with a decision. It begins with a tolerance."
  - "By the time drift is visible to leadership, it has been visible to the team for a long time."
  - "The organizations most at risk of drift are the ones that believe their culture is healthy because nothing has broken yet."
applications: []
related:
  - "ali-series-stability-the-environment-that-holds"
