...
categories:
  - servant-leadership
  - culture-science
featured_image: ../images/ali-series-trust-the-condition-that-cannot-be-declared.jpg
takeaways:
  - "Trust is not built through intention. It is built through a repeatable pattern of behavior."
  - "The absence of visible conflict is not evidence of trust. It is often evidence of the opposite."
  - "Leaders who do not know whether their team trusts them almost certainly have their answer."
applications: []
related:
  - "ali-series-consistency-the-leader-people-learn-to-predict"
  - "ali-series-alignment-one-story-one-direction"
