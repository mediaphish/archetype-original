...
summary: >-
  We are going to spend the next seven posts talking about the conditions that
  determine whether your leadership is actually working. Not whether you think
  it is working. Whether the people living inside the system you have built
  experience it as working.
categories:
  - servant-leadership
  - culture-science
...
takeaways:
  - >-
    ...
    actually experience is where organizations quietly lose.
  - >-
    Seven conditions shape leadership health. They build on each other and can
    unravel from either end.
  - Narrowing the gap matters. In any condition. In all of them.
applications: []
related:
