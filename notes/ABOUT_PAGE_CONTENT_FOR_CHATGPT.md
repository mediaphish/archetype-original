# PROMPT FOR CHATGPT: Rework About Page Content

## CONTEXT
I need you to rework the content from my About page based on new content we've been working on. Below is the current content from the /about page, organized by sections. Please rework this content while maintaining the same structure, voice (first-person singular), and tone.
...
### ORIGINS SECTION
**Title:** From Design to Direction
...
### THE BUILDER'S DECADE SECTION
**Title:** Team, Standards, and Service
...
**Subsection Title:** What that looked like (themes, not stories)

**Bullet Points:**
- Hiring for character and fit, then teaching the craft and the system.
- Protecting the team from toxic dynamics—even when it risked revenue.
- Building simple rhythms so good people could do great work.

---

### SERVICE BEFORE SPOTLIGHT SECTION
...
### THE COST AND THE COMEBACK SECTION
**Title:** The Cost and the Comeback
...
### ARCHETYPE ORIGINAL SECTION
**Title:** Back to Purpose — Archetype Original
...
**Title:** How I Engage (today's work)
...
**Title:** What It's Like to Work Together (rules of engagement)

**Bullet Points:**
- **Honest by default.** I won't be a "yes-man." We address the real issue, directly.
- **Human first.** I treat people the way I want to be treated—especially under pressure.
- **No dependency.** Success is when you don't need me anymore.
- **Shared accountability.** Accountability is owned most by the person being accountable.
- **Conversation over program.** Real situations. Real plans. Real execution. No subscriptions.

---

### WHERE WE START SECTION
**Title:** Where We Start (personal clarity first)
...
**Subsection Title:** Signals we're on track

**Bullet Points:**
- Language becomes clearer; decisions stop looping.
- Teams stop protecting themselves and start protecting the mission.
- Energy returns without bravado.
- You feel strong and calm at the same time.

---

### WHY THIS WORKS SECTION
**Title:** Why This Works (research in plain language)
...
### WHAT YOU TAKE WITH YOU SECTION
**Title:** What I Hope You Take With You
...
Please rework this About page content based on the new content we've been working on. Maintain:
- The same section structure
- First-person singular voice
- The same tone and style
- All pull quotes (but you can refine them if needed)
- All bullet point lists
- The same level of detail and authenticity

Update the content to reflect any new information, stories, or perspectives we've discussed, while keeping the overall narrative flow and structure intact.
