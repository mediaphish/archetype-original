...
export default function ReportsMirror() {
  ...
  const getArchyContextPayload = useCallback(
    () => buildAliMirrorSnapshot(liveSummary),
    [liveSummary]
  );
  ...
  return (
    <div className="min-h-screen bg-gray-50">
            ...
            <div className="flex items-start justify-between gap-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <button
                  ...
                  className="min-h-[44px] inline-flex items-center justify-center gap-2 px-4 py-2 rounded-lg bg-blue-600 text-white font-semibold hover:bg-blue-700 transition-colors whitespace-nowrap"
                >
      ...
      <AliArchyDrawer
        ...
        initialMessage={
          archyInitialMessage ||
          "I'm reviewing my Leadership Mirror. Help me understand what this gap means and what to do next."
        }
