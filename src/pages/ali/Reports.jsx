...
const ALIReports = () => {
  ...
  const getArchyContextPayload = useCallback(
    () => buildAliReportsSnapshot(liveReports, liveDashboardSummary),
    [liveReports, liveDashboardSummary]
  );
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <AliArchyDrawer
        ...
        initialMessage={
          archyInitialMessage ||
          "I'm looking at my Leadership Trends & Analytics report. Can you help me interpret the patterns, trends, and insights I'm seeing?"
        }
