        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="px-4 py-2 text-sm font-semibold text-[#1A1A1A] hover:text-[#C85A3C]"
            >
              Log In
            </button>
          </div>
      ...
      <main>
          ...
          <div className="container mx-auto px-4 max-w-4xl text-center">
            ...
            <div className="flex gap-4 justify-center">
              <button
                ...
                className="px-6 py-3 bg-[#C85A3C] text-white font-semibold rounded-lg hover:bg-[#B8492A]"
              >
                Get Started
              </button>
              <button
                onClick={() => handleNavigate('/ali/login')}
                className="px-6 py-3 border border-gray-300 text-[#1A1A1A] font-semibold rounded-lg hover:bg-gray-50"
              >
                Log In
              </button>
            </div>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4 max-w-4xl">
            <h2 className="text-3xl font-bold text-[#1A1A1A] mb-6">What is ALI?</h2>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4 max-w-4xl">
            <h2 className="text-3xl font-bold text-[#1A1A1A] mb-6">How ALI Works</h2>
            <div className="grid md:grid-cols-3 gap-6">
              <div className="p-6 border border-gray-200 rounded-lg">
                <h3 className="text-xl font-semibold mb-2">1. Deploy Survey</h3>
                <p className="text-gray-600">Send a 10-question survey to your team quarterly</p>
              </div>
              <div className="p-6 border border-gray-200 rounded-lg">
                <h3 className="text-xl font-semibold mb-2">2. Collect Responses</h3>
                <p className="text-gray-600">Team members respond anonymously</p>
              </div>
              <div className="p-6 border border-gray-200 rounded-lg">
                <h3 className="text-xl font-semibold mb-2">3. View Insights</h3>
        ...
        <section className="py-16 bg-[#1A1A1A] text-white">
          <div className="container mx-auto px-4 max-w-4xl text-center">
            ...
            <p className="text-lg mb-6">Join the ALI pilot program</p>
            <button
              onClick={() => handleNavigate('/ali/signup')}
              className="px-6 py-3 bg-[#C85A3C] text-white font-semibold rounded-lg hover:bg-[#B8492A]"
            >
