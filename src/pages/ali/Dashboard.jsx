          ...
          <div className="bg-gradient-to-r from-blue-50 to-blue-100 rounded-lg border-2 border-blue-300 p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-white rounded-lg border border-gray-200 p-6">
                ...
                <div className="text-sm text-gray-500">Rolling: {mockData.scores.ali.rolling.toFixed(1)}</div>
              </div>
              
              {/* Zone Indicator */}
              <div className="bg-white rounded-lg border border-gray-200 p-6">
                <div className="text-sm font-medium text-gray-600 mb-2">Current Zone</div>
                <div className="text-3xl font-bold text-yellow-600 mb-2 capitalize">
                  {mockData.scores.ali.zone}
                </div>
