          ...
          <div className="container mx-auto px-4 sm:px-6 md:px-12">
            <div className="max-w-4xl mx-auto space-y-8">
              ...
              <div className="text-base sm:text-lg leading-relaxed text-[#1A1A1A] space-y-6">
                <p>
                  Scoreboard Leadership is a dominance pattern where <strong>metrics are weaponized to drive compliance</strong>, optics outrank outcomes, and people become a means to public wins. The score replaces the standard; theater replaces trust.
                </p>
                <p>
            ...
            <div className="max-w-4xl mx-auto space-y-8">
              ...
              <div className="text-base sm:text-lg leading-relaxed text-[#1A1A1A]">
                <ul className="list-disc pl-6 sm:pl-8 space-y-4 marker:text-[#C85A3C]">
                  ...
                  <li>
                    <strong>Top-down pressure cycles</strong> Solution: Servant standards with owner-operators + weekly inspect-and-improve.
                  </li>
                  <li>
                    <strong>Prestige over people</strong> Solution: Reward maintenance wins, cross-team assists, and clean handoffs.
                  </li>
                  <li>
                    <strong>Churn masked by hype</strong> Solution: Track role tenure, cross-training depth, and regretted attrition.
                  </li>
                  <li>
                    <strong>Hero dependency</strong> Solution: One-page plays with backups and rituals that survive PTO and turnover.
                  </li>
                  <li>
                    <strong>Busy over outcomes</strong> Solution: One page, one owner, one outcome per initiative — inspect weekly.
                  </li>
                  <li>
                    <strong>Vanity pipeline</strong> Solution: Qualify for fit; publish kill-criteria; celebrate strategic "no" calls.
                  </li>
                  <li>
