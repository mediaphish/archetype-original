/**
 * Team Culture Mentoring Page
 * 
 * Purpose: Detail page for team culture consulting service
...
export default function TeamCulture() {
  return (
    <>
      <SEO pageKey="mentoring-team-culture" />
      <div className="min-h-screen bg-warm-offWhite py-12 pt-28">
        <div className="container">
          <div className="max-w-4xl mx-auto">
            <h1 className="h1 mb-8">Team Culture</h1>
