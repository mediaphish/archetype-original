        ...
        <div className="container mx-auto px-4 sm:px-6 md:px-12">
          <div className="max-w-4xl mx-auto">
            ...
            <article className="bg-white border border-[#1A1A1A]/10">
              ...
              {/* Social Sharing - Minimal Editorial Style */}
              {post && (
              <div className="mb-8 sm:mb-10 pb-6 border-b border-[#1A1A1A]/10">
                <div className="flex items-center gap-3">
                  <span className="text-xs text-[#6B6B6B] font-normal uppercase tracking-wider">Share</span>
                  <div className="flex items-center gap-2">
                    {/* Twitter - Icon only, subtle */}
                    <button
