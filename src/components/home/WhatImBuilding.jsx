...
export default function WhatImBuilding() {
  return (
    <section className="pt-0 pb-32 bg-gradient-to-b from-white via-white to-[#F5F5F5]" style={{backgroundImage: 'linear-gradient(to bottom, white 0%, white 30%, #F5F5F5 100%)'}}>
