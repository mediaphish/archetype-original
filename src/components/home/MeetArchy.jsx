            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div>
                <div className="inline-block mb-6 sm:mb-8">
                  <span className="text-sm font-medium text-[#1A1A1A]">Your AI Guide</span>
                </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm" onClick={() => setIsChatOpen(false)}>
          <div className="w-full max-w-2xl h-[85vh] max-h-[700px] flex flex-col" onClick={(e) => e.stopPropagation()}>
            <div className="bg-white h-full flex flex-col overflow-hidden">
              {/* Header */}
              <div className="flex items-center justify-between p-4 border-b border-[#1A1A1A]/10 flex-shrink-0">
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-semibold text-[#1A1A1A]">Archy</span>
                </div>
                <button
                  onClick={() => setIsChatOpen(false)}
                  className="text-[#6B6B6B] hover:text-[#1A1A1A] transition-colors text-2xl leading-none"
