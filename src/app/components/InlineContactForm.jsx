    ...
    <div className="mt-4 p-4 bg-white border border-warm-border rounded-lg">
      ...
      <form onSubmit={submit} className="space-y-4">
        ...
        <button 
          type="submit"
          disabled={status.loading}
          className="w-full bg-amber text-white px-4 py-2 rounded-lg font-semibold text-sm hover:bg-amber-dark transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
        >
