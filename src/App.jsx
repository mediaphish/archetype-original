...
import PodcastGuestView from "./pages/PodcastGuestView";
...
import ReportsProfile from "./pages/ali/ReportsProfile";
...
import AOReviewQueue from "./pages/ao/ReviewQueue";
import AOAutoDrafts from "./pages/ao/AutoDrafts";
...
export default function App() {
  ...
  const getInitialPage = () => {
    ...
    if (path.startsWith('/ali/')) {
      ...
      if (path === '/ali/reports/profile') return 'ali-reports-profile';
    ...
    const handleRoute = () => {
      ...
      if (path.startsWith('/operators/')) {
        ...
        if (path === '/operators/events') {
          ...
          if (eventPath === 'new') {
            setCurrentPage('operators-create-event');
          } else if (eventPath.endsWith('/edit')) {
            setCurrentPage('operators-edit-event');
          } else if (eventPath) {
      ...
      if (path === '/' || path === '') {
      ...
      } else if (/^\/podcast\/guest\/[^/]+$/.test(path)) {
        ...
        if (path === '/culture-science/ali' || path.startsWith('/culture-science/ali/')) {
          ...
          setCurrentPage('bad-leader-project');
        } else if (path.startsWith('/culture-science/bad-leader-project/cluster/')) {
          setCurrentPage('bad-leader-project');
  ...
  // Render Podcast guest private show page
  if (currentPage === 'podcast-guest-view') {
    return (
      <main className="bg-warm-offWhite text-warm-charcoal">
        <PodcastGuestView />
      </main>
  ...
  if (currentPage === 'ali-reports-profile') {
    return <ReportsProfile />;
  }
  ...
  if (currentPage === 'ao-auto-drafts') {
    return <AOAutoDrafts />;
  }
  if (currentPage === 'ao-review-queue') {
    return <AOReviewQueue />;
  }
