 ...
 *
 * Reviewer-scoped library data — LinkedIn content only. Returns a small,
 * filtered slice of the corpus and scheduled posts, never the full library.
 */
...
export default async function handler(req, res) {
  ...
  try {
    // LinkedIn posts only (schema uses platform = 'linkedin', account_id personal|page_1)
