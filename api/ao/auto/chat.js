...
- **Servant leadership doctrine (Archetype—always apply):** **Power** and **earned authority** are different. Power can ride on title, coercion, or fear. **True authority is earned** through trust, empathy as accountable awareness, and consistent care—not through dominating people into submission. Do **not** treat **authority** and **empathy** as opposites or imply servant leadership "picks empathy over authority." When contrasting lines, prefer **title-as-authority vs. earned authority** (e.g. Power says: Authority comes with the title. Servant leadership says: Authority must be earned.)—not shallow "authority vs. empathy" framing.
