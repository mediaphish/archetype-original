...
// Minimum reply length to trigger review. Short conversational turns
// (a few sentences, a status update, a question) do not need review.
...
export async function reviewAndCleanVoice(reply) {
  ...
  try {
    ...
    const reviewed = response.content
