...
export const DEFAULT_POSE =
  ...
  'hands resting open on the chair arms, relaxed and unhurried';
...
export function buildLikenessArtworkPrompt({
  ...
  return [
    ...
    // fall away instead.
    // These two halves need opposite treatment, and saying "deep shadows"
    // globally made the model darken everything including him. State the split.
    `THE ${side} HALF, where he is: bright, warm, fully lit, natural colour. His face evenly lit with no heavy shadow across it. The room behind him visible and inviting.`,
    `THE ${emptySide} HALF: unlit, near-black, empty. The darkness belongs there and nowhere else.`,
    'His expression is warm and settled, on the edge of a smile, the look of someone who is glad to be talking to you. Not stern, not brooding, not grim, not eerie, not blank.',
