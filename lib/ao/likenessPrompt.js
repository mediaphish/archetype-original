...
export const DEFAULT_SCENE =
  'a dark, moody interior with deep shadows and warm practical lights far in the background';
...
const AUTHENTICITY = [
  ...
  'Always keep his dark-framed rectangular eyeglasses, his full beard, and the tattoos on his forearms,',
  'regardless of the clothing or setting described.',
].join(' ');
...
export function buildLikenessArtworkPrompt({
  ...
  mood = 'a calm, steady expression, looking directly at the camera',
  extra = '',
} = {}) {
  ...
  return [
    ...
    'Cinematic contrast and deep shadows so the empty half reads as solid darkness.',
