...
Generates 1080x1080 PNG cards. Default theme: near-black background (#0a0a0a), white bold text, white AO mark at 50% opacity. Light theme: white background, near-black text (#0a0a0a), black AO mark at 50% opacity. Bart can request the light theme by saying "white background," "light theme," "flip the colors," or similar. The renderer detects this automatically — no special command needed. Triggered automatically when Bart approves captions or explicitly asks for images from locked card copy. Fast, consistent, always looks the same. This is the right tool for quote cards.
