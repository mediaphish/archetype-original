...
export const AUTO_TOOL_SCHEMAS = [
  ...
  },
  {
    ...
    description:
      ...
      'Set likeness=true ONLY when the quote is Bart\'s own words — that generates a stylized image of him. For anyone else\'s quote leave it false, which produces scene artwork with no people in it. ' +
      'Break the quote into short display lines yourself: the display face is condensed all-caps and is for short lines only, so 2-6 words per line reads best. Do not send one long line. ' +
