...
export const AUTO_TOOL_SCHEMAS = [
  ...
  },
  {
    ...
    description:
      'Build a quote card from a quote string attributed to a source document/draft slug. Phase 2 will require verify_quote before cards ship; Phase 1 accepts typed arguments only.',
    input_schema: {
      type: 'object',
      properties: {
        quote_text: {
