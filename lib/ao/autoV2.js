...
Your highest-performing post in the last 90 days was on ${platform} on ${date}: "${caption}..." with ${topReactions} reactions — ${Math.round(outperformRatio * 100 - 100)}% above your ${platform} average.

That post came from: ${slug}

**What this means:** This topic and angle is resonating. If you have not already derived additional content from this piece (LinkedIn chunks, quote cards, Instagram posts), now is the time. If you have new content in the same territory, it has a proven audience.

Surface this at the start of the session if no specific task has been stated. One sentence: "Your [platform] post on [topic] from [date] outperformed your average by [X]% — worth building on."`;
