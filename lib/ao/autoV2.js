...
export const AUTO_TOOL_SCHEMAS = [
  ...
  },
  {
    ...
    description:
      'Publish a journal entry to the live site (GitHub journal file + caption scheduling). Still subject to Bart\'s explicit publish confirmation checkpoint in the UI.',
    input_schema: {
      type: 'object',
      properties: {
        slug: {
