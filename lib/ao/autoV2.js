...
export async function runAutoChat(history = [], userMessage = '', scheduleContext = null, plainTextMessage) {
  ...
  const corpusContext = contextProfile.forceCorpusResearch
    ...
    : corpusContextRaw;
  const systemPrompt = buildSystemPrompt(corpusContext, publishedContext, performanceContext, imageSeriesContext, approvedDraftsContext, seriesContext, proactiveInsight, statedPreferencesContext, seriesMemoryContext, guardrailsContext);
