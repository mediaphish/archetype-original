...
1. Bart approves (or edits) the post body.
2. Then emit [OPPORTUNITY_GENERATE_IMAGE id="uuid" pull_quote="optional verbatim line"] — the server
   ...
   for opportunity companion posts.
