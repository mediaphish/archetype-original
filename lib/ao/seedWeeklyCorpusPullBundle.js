...
export async function seedWeeklyCorpusPullBundle({
  ...
  const out = await supabaseAdmin
    ...
    .insert({
      ...
      why_it_matters: `Automated weekly pick from your published writing (${safeText(bundle.theme_query, 120)}). Lines are chosen to stand alone with impact. Review the cards and captions, then schedule to Instagram or reject.`,
      summary_interpretation: `This bundle is ready for your review—no Analyst brief step. Use “Schedule Instagram week” to queue posts (caption + quote + source link), or reject if you want a different week. Future versions can tighten automation once you’re happy with the quality bar.`,
      studio_playbook,
