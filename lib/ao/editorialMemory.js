 ...
 * @param {string} params.seriesSlug - Base slug of the series, e.g. "power-vs-authority"
 * @param {string} params.partSlug - Full slug of this part, e.g. "power-vs-authority-part-1-the-hunger"
      ...
      .upsert(
        {
          ...
          title: `${seriesSlug} — Part ${partNumber}`,
          body_text: prompt || '',
