...
/** White AO logomark (concentric circles) — must read on #0a0a0a background */
...
// ── AO Mark ───────────────────────────────────────────────────────────────────
/** Concentric-circle AO mark; size = outer radius (~60px tall when size is 30). */
...
function generateCardBuffer(line1, line2) {
  ...
  // ~60px tall mark, centered, ~80px above bottom edge (cy 970, radius 30)
  drawAOMark(ctx, WIDTH / 2, HEIGHT - 80 - 30, 30);
