...
function fallbackDecision(row) {
  ...
  return {
    ...
    studio_playbook: {
      ...
      angles: [
        'Name the pattern (what the quote reveals) and give one practical leadership move.',
        'Turn the quote into a self-audit question for leaders under pressure.',
        'Frame it as foundation-building: identity, humility, alignment before the storm.',
      ].slice(0, 3),
      alignment_flags: [],
      corpus_anchors: [],
    },
