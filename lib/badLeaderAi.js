...
Story:
${storyText}`;
  // Rewriting a real person's submission so nobody can be identified from it.
  // A miss exposes someone, so this gets the strongest model.
  return chatText(systemPrompt, userPrompt, 'draft');
}
